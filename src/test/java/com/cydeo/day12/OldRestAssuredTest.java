...
public class OldRestAssuredTest extends SpartanNewBase {
    ...
    /*
         NOT : expect() is old version. Difference between the new one is old version makes soft assertions. It means
               it does not stop the assertions and goes on asserting after making the first assertion.
